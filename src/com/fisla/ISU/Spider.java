...
public class Spider extends Enemies {
    ...
    // Constructor
    public Spider(int topLeftX, int topLeftY, double speed, int wanderFrequency, int aggressiveness, String type) {
        ...
        if (type.equalsIgnoreCase("normal")) {
            setImage("assets/characters/enemies/spider.png");
            totalHealth = 100;
            health = totalHealth;
        }
    ...
    public void update() {
        ...
        if (!chasing) {
            ...
            if (Start.getTick() < chaseStartTick + 20) {
                SPEED = 2;
            } else {
                SPEED = 0.5;
            }
    ...
    public void die() {
        spider.remove(this);
        statCounter.put("spider", Enemies.statCounter.get("spider") + 1);
    }
